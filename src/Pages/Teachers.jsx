...
const Teachers = () => {
    ...
    const { teacher, handleViewMore } = useContext(AppContext);
    ...
    const filteredTeachers = selectedCategory === "all" ? teacher : 
        teacher.filter(t => t.category === selectedCategory);
    ...
    return (
        <div className="bg-[#121212] min-h-[calc(100vh-140px)] p-4 lg:p-6 rounded-xl">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
                ...
                {
                    [...new Set(teacher.map(t => t.category))].map((category, idx) => (
